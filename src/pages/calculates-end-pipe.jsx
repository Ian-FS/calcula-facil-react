...
export default function EndPipePage({ showResult, setShowResult }) {
  ...
  const addTime = () => {
    ...
    if (endTime() > 0 && endTime() < 999999) {
      let mensagem = `Término do tubo na boca da ferramenta previsto para ${diaDaSemana}, ${newDays
        .toString()
        .padStart(2, '0')} de ${meses[newMonth]} de ${newYears}, às ${newHours
        .toString()
    ...
    <>
      {!showResult && (
        <form className="form" onSubmit={handleClick}>
          <div>
            <h2 style={{ marginBottom: '10px' }}>Informações de produção:</h2>
            <InputBox
              labelBox={'Tubo total a ser produzido (m):'}
            ...
            />
            <InputBox
              labelBox={'Velocidade da linha no painel (m/min):'}
            ...
            <h2 style={{ marginBottom: '10px' }}>Linha de produção:</h2>
